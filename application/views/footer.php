		...
		<div class="container pt-70 pb-40">
			<div class="row border-bottom-black">
				<div class="col-sm-6 col-md-3">
					<div class="widget dark"> <img alt="" src="<?php echo base_url();?>assets/images/logo-wide-white-footer.png">
				...
				<div class="col-sm-6 col-md-3">
					<div class="widget dark">
						...
						<form id="footer_quick_contact_form" name="footer_quick_contact_form" class="quick-contact-form" action="http://kodesolution.website/html/j/childhaven/v2.0/demo/includes/quickcontact.php" method="post">
